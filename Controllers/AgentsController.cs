...
namespace MyStoreApp.Controllers
{
    ...
    public class AgentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AgentId,AgentName,ContactInfo,Email")] Agent agent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AgentId,AgentName,ContactInfo,Email")] Agent agent)
        {
            if (ModelState.IsValid)
            {
